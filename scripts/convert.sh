...
nvim -u scripts/init.lua -c "lua require('babelfish').generate_readme({input_file='tests/README.md', output_file = 'tests/help.txt', project_name='lspconfig'})" -c "q"  --headless
